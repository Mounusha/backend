package com.niit.shopback.config;
...
import com.niit.shopback.DAO.CategoryDAOImpl;
import com.niit.shopback.DAO.ProductDAO;
import com.niit.shopback.DAO.ProductDAOImpl;
import com.niit.shopback.DAO.SupplierDAO;
import com.niit.shopback.DAO.SupplierDAOImpl;
import com.niit.shopback.DAO.UserDAO;
import com.niit.shopback.DAO.UserDAOImpl;
...
@Configuration
@ComponentScan("com.niit.shopback")
...
public class ApplicationcontextConfig {
	...
	public SupplierDAO geSupplieDao(SessionFactory sessionFactory) {
		return new SupplierDAOImpl(sessionFactory);
}
	@Autowired
	@Bean(name = "ProductDAO")
	public ProductDAO geproducDao(SessionFactory sessionFactory) {
		return new ProductDAOImpl(sessionFactory);
}
	@Autowired
	@Bean(name = "UserDAO")
	public UserDAO geUseDao(SessionFactory sessionFactory) {
